...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataList.add(new DrawerItem(this.getResources().getString(R.string.RunningLabel), R.drawable.ic_running_tracker, true));
        dataList.add(new DrawerItem(this.getResources().getString(R.string.FoodLabel), R.drawable.ic_food_tracker, true));
